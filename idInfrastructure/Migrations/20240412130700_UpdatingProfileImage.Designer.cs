...
namespace idInfrastructure.Migrations
{
    ...
    [Migration("20240412130700_UpdatingProfileImage")]
    partial class UpdatingProfileImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("idInfrastructure.Entities.AddressEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("idInfrastructure.Entities.UserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("idInfrastructure.Entities.AddressEntity", b =>
                {
                    b.HasOne("idInfrastructure.Entities.UserEntity", "User")
                        .WithMany("Address")
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("idInfrastructure.Entities.FeatureItemEntity", b =>
                {
                    b.HasOne("idInfrastructure.Entities.FeatureEntity", "Feature")
